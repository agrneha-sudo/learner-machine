...
import { LayoutDashboard, Package, ShoppingBag, ExternalLink, Settings, LayoutTemplate, Users, Newspaper } from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/blocks', label: 'Content Sections', icon: LayoutTemplate },
